...
mixin _$HomeState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(int age) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(int age)? success,
...
class _$_Success implements _Success {
  const _$_Success({required this.age});
  ...
  @override
  String toString() {
    return 'HomeState.success(age: $age)';
  }
...
abstract class _Success implements HomeState {
  const factory _Success({required final int age}) = _$_Success;
